# Project-Rock-Paper-Scissors
	...
	[from Wikipedia](https://en.wikipedia.org/wiki/Rock_paper_scissors)

## A TOP project
	The aim of the project is to recreate a Rock, Paper, Scissor game played through the console of a web browser and against a computer/AI player and a human player. Input from the player is gotten through a prompt and match between the random choice of the computer to determine  a winner.
